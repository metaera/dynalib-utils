...
# LLVM-COV:
#   ccov : Generates HTML code coverage report for every target added with 'AUTO' parameter.
#   ccov-report : Prints summary per-file coverage information for every target added with 'AUTO' parameter.
#   ccov-all : Generates HTML code coverage report, merging every target added with 'ALL' parameter into a single detailed report.
...
#   ccov-run-${TARGET_NAME} : Generates coverage data only.
#   ccov-report-${TARGET_NAME} : Prints to command line summary per-file coverage information.
#   ccov-show-${TARGET_NAME} : Prints to command line detailed per-line coverage information.
#
#=====================================================================================================================================

# The following line will cause option handling to work according to the NEW policy of ignoring any previous setting of the option
...
# Programs
find_program(LLVM_COV_PATH llvm-cov PATHS /usr/local/opt/llvm/bin)
message(STATUS "llvm-cov found: ${LLVM_COV_PATH}")
find_program(LLVM_PROFDATA_PATH llvm-profdata PATHS /usr/local/opt/llvm/bin)
message(STATUS "llvm-profdata found: ${LLVM_PROFDATA_PATH}")
...
function(add_code_coverage)
  message(STATUS "Adding code coverage instrumentation")
  if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang"
     OR CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
    add_compile_options(-fprofile-instr-generate -fcoverage-mapping)
    add_link_options(-fprofile-instr-generate -fcoverage-mapping)
    message(STATUS "Code coverage instrumentation added to all targets")
  elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" 
          OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
